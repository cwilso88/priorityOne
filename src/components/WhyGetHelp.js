                ...
                <div className="whygethelp_checklist">
                    ...
                    <div className="whygethelp_checklist_container row">
                        <ul className="column">
                            ...
                            <li><FontAwesomeIcon className="icon" icon={ faCheckCircle } />Is IT staff pulled off important tasks to deal with user complaints?</li>
                        ...
                        <ul className="column">
                            ...
                            <li><FontAwesomeIcon className="icon" icon={ faCheckCircle } />Are slow networks hampering your employee’s productivity?</li>
                        </ul>
                    </div>
                </div>
            </section>
